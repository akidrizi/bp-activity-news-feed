...
class iEfimerida extends Feed {

    // RSS 2.0 Feed
    const RSS_URI = 'http://www.iefimerida.gr/rss.xml';
    ...
    public function get_description(){
        ...
        $iefimerida_description = $this->strip_head_and_paragraph_tags($description);

        if ( $iefimerida_description !== null )
            return $iefimerida_description;
